...
struct Z_Construct_UClass_ASpartaCharacter_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bIsSlowed_MetaData[] = {
		...
		{ "Comment", "// \xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd \xef\xbf\xbd\xdf\xb0\xef\xbf\xbd: SlowingItem\xef\xbf\xbd\xef\xbf\xbd \xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\n" },
#endif
		{ "ModuleRelativePath", "Public/SpartaCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd \xef\xbf\xbd\xdf\xb0\xef\xbf\xbd: SlowingItem\xef\xbf\xbd\xef\xbf\xbd \xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SlowedSpeed_MetaData[] = {
		{ "Category", "Movement" },
		{ "ModuleRelativePath", "Public/SpartaCharacter.h" },
	};
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_SlowedSpeed;
...
void Z_Construct_UClass_ASpartaCharacter_Statics::NewProp_bIsSlowed_SetBit(void* Obj)
{
	((ASpartaCharacter*)Obj)->bIsSlowed = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ASpartaCharacter_Statics::NewProp_bIsSlowed = { "bIsSlowed", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(ASpartaCharacter), &Z_Construct_UClass_ASpartaCharacter_Statics::NewProp_bIsSlowed_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsSlowed_MetaData), NewProp_bIsSlowed_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ASpartaCharacter_Statics::NewProp_SlowedSpeed = { "SlowedSpeed", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASpartaCharacter, SlowedSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SlowedSpeed_MetaData), NewProp_SlowedSpeed_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpartaCharacter_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpartaCharacter_Statics::NewProp_bIsSlowed,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpartaCharacter_Statics::NewProp_SlowedSpeed,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_USER_Documents_Unreal_Projects_SpartaProject_Source_SpartaProject_Public_SpartaCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASpartaCharacter, ASpartaCharacter::StaticClass, TEXT("ASpartaCharacter"), &Z_Registration_Info_UClass_ASpartaCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpartaCharacter), 1796756201U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_USER_Documents_Unreal_Projects_SpartaProject_Source_SpartaProject_Public_SpartaCharacter_h_3777021392(TEXT("/Script/SpartaProject"),
	Z_CompiledInDeferFile_FID_Users_USER_Documents_Unreal_Projects_SpartaProject_Source_SpartaProject_Public_SpartaCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_USER_Documents_Unreal_Projects_SpartaProject_Source_SpartaProject_Public_SpartaCharacter_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
